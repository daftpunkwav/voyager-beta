...
DEFS = [
    ...
    SettingDef(key="notes.ui.filter", module="notes", type=SettingType.CHOICE,
               default="all", choices=("all", "pinned", "untitled", "unlinked", "today"),
               description="笔记首页筛选:全部/置顶/草稿标题/未关联/今日"),
    SettingDef(key="notes.ui.query", module="notes", type=SettingType.STR,
               default="",
               description="笔记首页关键词(标题或摘要)"),
    SettingDef(key="notes.ui.source_id", module="notes", type=SettingType.STR,
               default="",
               description="笔记首页按关联资源筛选(空=全部)"),
    SettingDef(key="notes.ui.panel", module="notes", type=SettingType.CHOICE,
               default="none", choices=("none", "trash"),
               description="笔记页打开的面板:无/回收站"),
