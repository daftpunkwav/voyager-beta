...
# assets/engine-integrations.json.
#
...
tmp="$out.tmp.$$"
{
    ...
    echo "#ifndef ENGINE_INTEGRATIONS_HASH_H"
    echo "#define ENGINE_INTEGRATIONS_HASH_H"
    echo "#define ENGINE_INTEGRATIONS_SHA256 \"$hash\""
    echo "#endif"
} >"$tmp"
mv "$tmp" "$out"
