...

{
    ...
    echo
    echo "This file accompanies the graph-engine binary distribution."
    ...
    echo "---"
    echo
    cat "$ROOT/internal/engine/vendored/grammars/MANIFEST.md"

    find "$ROOT/vendored" "$ROOT/internal/engine/vendored" -type f \
