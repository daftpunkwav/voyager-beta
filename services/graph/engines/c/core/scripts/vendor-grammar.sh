#!/usr/bin/env bash
# vendor-grammar.sh: Vendor a single tree-sitter grammar into internal/engine/vendored/grammars/<name>/
...
GRAMMAR_DIR="$PROJECT_DIR/internal/engine/vendored/grammars/$NAME"
TMPDIR="$(mktemp -d)"
