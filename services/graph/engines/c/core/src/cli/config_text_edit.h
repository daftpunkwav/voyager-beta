 ...
 */
#ifndef ENGINE_CLI_CONFIG_TEXT_EDIT_H
#define ENGINE_CLI_CONFIG_TEXT_EDIT_H
...
typedef void (*engine_text_precommit_test_hook_t)(const char *file_path, void *context);
