 ...
 */
#ifndef ENGINE_AST_PROFILE_H
#define ENGINE_AST_PROFILE_H
 ...
 * buf must be at least ENGINE_AST_PROFILE_BUF bytes. */
enum { ENGINE_AST_PROFILE_BUF = 200 };
 ...
 * out must have ENGINE_AST_PROFILE_DIMS elements. */
void engine_ast_profile_to_vector(const engine_ast_profile_t *p, float *out);

#endif /* ENGINE_AST_PROFILE_H */
