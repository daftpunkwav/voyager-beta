#ifndef ENGINE_MCP_INTERNAL_H
#define ENGINE_MCP_INTERNAL_H

#include "mcp/mcp.h"
#include "pipeline/pipeline.h" /* engine_changed_hunk_t */
#include "store/store.h"       /* engine_node_t */
...
typedef bool (*engine_mcp_quarantine_test_hook_fn)(void *context, const char *step);
typedef bool (*engine_mcp_command_test_hook_fn)(void *context, const char *command);
 ...
 * engine_mcp_server_new(NULL) semantics remain unchanged; daemon sessions use
...
enum { ENGINE_MCP_DEFAULT_AUTO_INDEX_LIMIT = 50000 };
