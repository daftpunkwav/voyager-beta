 ...
 */
#ifndef ENGINE_DAEMON_HOST_INTERNAL_H
#define ENGINE_DAEMON_HOST_INTERNAL_H
...
typedef bool (*engine_daemon_host_cleanup_release_for_test_fn)(void *context);
...
bool engine_daemon_host_state_prepare_for_test(const struct engine_daemon_ipc_endpoint *endpoint);
...
} engine_daemon_host_http_reconcile_test_result_t;
...
} engine_daemon_host_http_free_refusal_test_result_t;
...
#endif /* ENGINE_DAEMON_HOST_INTERNAL_H */
