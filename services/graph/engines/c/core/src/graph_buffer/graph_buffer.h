 ...
 */
#ifndef ENGINE_GRAPH_BUFFER_H
#define ENGINE_GRAPH_BUFFER_H
 ...
 * If id_source is NULL, behaves like engine_gbuf_new(). */
...
typedef void (*engine_gbuf_node_visitor_fn)(const engine_gbuf_node_t *node, void *userdata);
void engine_gbuf_foreach_node(const engine_gbuf_t *gb, engine_gbuf_node_visitor_fn fn, void *userdata);

/* Iterate all edges. */
typedef void (*engine_gbuf_edge_visitor_fn)(const engine_gbuf_edge_t *edge, void *userdata);
 ...
 * Vectors are carried through to engine_write_db during the dump phase. */
