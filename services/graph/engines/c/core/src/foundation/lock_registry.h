 ...
 */
#ifndef ENGINE_LOCK_REGISTRY_H
#define ENGINE_LOCK_REGISTRY_H
...
#define ENGINE_LOCK_REGISTRY_NAME_CAP 80U

typedef struct engine_lock_registry engine_lock_registry_t;
typedef struct engine_lock_lease engine_lock_lease_t;
typedef atomic_bool engine_lock_cancel_token_t;
...
/* deadline_ms is an absolute engine_now_ms() deadline; UINT64_MAX means no
