...
typedef void *(*engine_haskell_array_grow_fn)(void *, uint32_t, uint32_t *, uint32_t, size_t);
_Static_assert(_Generic(&_array__grow, engine_haskell_array_grow_fn: 1, default: 0),
