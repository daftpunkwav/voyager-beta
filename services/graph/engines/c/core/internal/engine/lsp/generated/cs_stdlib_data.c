...
#define REG_EXTENSION(qn_, short_name_, recv_, ret_type_)            \
    do {                                                             \
        ...
        {                                                            \
            ...
            rets[1] = NULL;                                          \
            const char **pnames =                                    \
                (const char **)engine_arena_alloc(arena, 2 * sizeof(*pnames)); \
            pnames[0] = "this";                                       \
            pnames[1] = NULL;                                        \
            const EngineType **ptypes =                                 \
                (const EngineType **)engine_arena_alloc(arena, 2 * sizeof(*ptypes)); \
            ptypes[0] = (recv_);                                     \
            ptypes[1] = NULL;                                        \
            rf.signature = engine_type_func(arena, pnames, ptypes, rets); \
        }                                                            \
        engine_registry_add_func(reg, rf);                              \
    } while (0)

#define OBJ() engine_type_named(arena, "System.Object")
#define STR() engine_type_named(arena, "System.String")
#define INT() engine_type_named(arena, "System.Int32")
#define LONG_T() engine_type_named(arena, "System.Int64")
#define BOOL_T() engine_type_named(arena, "System.Boolean")
#define DBL() engine_type_named(arena, "System.Double")
#define VOID_T() engine_type_named(arena, "System.Void")
#define UNK() engine_type_unknown()

void engine_csharp_stdlib_register(EngineTypeRegistry *reg, EngineArena *arena) {
    ...
    REG_METHOD("System.Object", "GetType", engine_type_named(arena, "System.Type"));
    ...
    REG_METHOD("System.String", "Split",
               engine_type_template(arena, "System.Array",
                                 (const EngineType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.String", "ToCharArray",
               engine_type_template(arena, "System.Array",
                                 (const EngineType *[]){engine_type_named(arena, "System.Char"), NULL},
                                 1));
    ...
    REG_STATIC("System.Convert", "ToSingle", engine_type_named(arena, "System.Single"));
    REG_STATIC("System.Convert", "ChangeType", OBJ());

    /* ── System.Guid ───────────────────────────────────────────── */
    REG_TYPE("System.Guid", "Guid", false, valuetype_parent);
    REG_STATIC("System.Guid", "NewGuid", engine_type_named(arena, "System.Guid"));
    REG_STATIC("System.Guid", "Parse", engine_type_named(arena, "System.Guid"));
    ...
    REG_STATIC("System.DateTime", "Now", engine_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "UtcNow", engine_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Today", engine_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Parse", engine_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "TryParse", BOOL_T());
    REG_METHOD("System.DateTime", "AddDays", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddHours", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMinutes", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddSeconds", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMilliseconds", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "Subtract", engine_type_named(arena, "System.TimeSpan"));
    REG_METHOD("System.DateTime", "ToString", STR());
    REG_METHOD("System.DateTime", "ToUniversalTime", engine_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "ToLocalTime", engine_type_named(arena, "System.DateTime"));
    ...
    REG_STATIC("System.DateTimeOffset", "Now", engine_type_named(arena, "System.DateTimeOffset"));
    REG_STATIC("System.DateTimeOffset", "UtcNow", engine_type_named(arena, "System.DateTimeOffset"));
    ...
    REG_STATIC("System.IO.File", "ReadAllBytes",
               engine_type_template(arena, "System.Array",
                                 (const EngineType *[]){engine_type_named(arena, "System.Byte"), NULL},
                                 1));
    ...
    REG_STATIC("System.IO.File", "Open", engine_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenRead", engine_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenWrite", engine_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "Create", engine_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "ReadAllTextAsync",
               engine_type_template(arena, "System.Threading.Tasks.Task",
                                 (const EngineType *[]){STR(), NULL}, 1));
    REG_STATIC("System.IO.File", "WriteAllTextAsync",
               engine_type_named(arena, "System.Threading.Tasks.Task"));
    ...
    REG_STATIC("System.IO.Directory", "CreateDirectory",
               engine_type_named(arena, "System.IO.DirectoryInfo"));
    ...
    REG_STATIC("System.IO.Directory", "EnumerateFiles",
               engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                 (const EngineType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.Text.StringBuilder", "Append",
               engine_type_named(arena, "System.Text.StringBuilder"));
    ...
    REG_STATIC("System.Text.Encoding", "UTF8", engine_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "ASCII", engine_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "Unicode", engine_type_named(arena, "System.Text.Encoding"));
    ...
    REG_STATIC("System.Text.RegularExpressions.Regex", "Match",
               engine_type_named(arena, "System.Text.RegularExpressions.Match"));
    REG_STATIC("System.Text.RegularExpressions.Regex", "Matches",
               engine_type_named(arena, "System.Text.RegularExpressions.MatchCollection"));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerable", "GetEnumerator",
               engine_type_template(arena, "System.Collections.Generic.IEnumerator",
                                 (const EngineType *[]){engine_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerator", "Current",
               engine_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.List", "Find", engine_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.List", "FindAll",
               engine_type_template(arena, "System.Collections.Generic.List",
                                 (const EngineType *[]){engine_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IDictionary", "Keys",
               engine_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const EngineType *[]){engine_type_type_param(arena, "TKey"), NULL},
                                 1));
    REG_METHOD("System.Collections.Generic.IDictionary", "Values",
               engine_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const EngineType *[]){engine_type_type_param(arena, "TValue"), NULL},
                                 1));
    ...
    REG_METHOD("System.Collections.Generic.Queue", "Dequeue", engine_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Queue", "Peek", engine_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.Stack", "Pop", engine_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Stack", "Peek", engine_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Key",
               engine_type_type_param(arena, "TKey"));
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Value",
               engine_type_type_param(arena, "TValue"));
    ...
    REG_METHOD("System.Span", "Slice",
               engine_type_template(arena, "System.Span",
                                 (const EngineType *[]){engine_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.ReadOnlySpan", "Slice",
               engine_type_template(arena, "System.ReadOnlySpan",
                                 (const EngineType *[]){engine_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Nullable", "Value", engine_type_type_param(arena, "T"));
    REG_METHOD("System.Nullable", "GetValueOrDefault", engine_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Threading.Tasks.Task", "Exception",
               engine_type_named(arena, "System.AggregateException"));
    ...
    REG_METHOD("System.Threading.CancellationTokenSource", "Token",
               engine_type_named(arena, "System.Threading.CancellationToken"));
    ...
    REG_METHOD("System.Exception", "InnerException",
               engine_type_named(arena, "System.Exception"));
    ...
    REG_EXTENSION("System.Linq.Enumerable.Where", "Where",
                   engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1),
                   engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.OrderBy", "OrderBy",
                   engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1),
                   engine_type_template(arena, "System.Linq.IOrderedEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.ToDictionary", "ToDictionary",
                   engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1),
                   engine_type_template(arena, "System.Collections.Generic.Dictionary",
                                     (const EngineType *[]){UNK(), UNK(), NULL}, 2));
    REG_EXTENSION("System.Linq.Enumerable.ToHashSet", "ToHashSet",
                   engine_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1),
                   engine_type_template(arena, "System.Collections.Generic.HashSet",
                                     (const EngineType *[]){engine_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_STATIC("System.Text.Json.JsonDocument", "Parse",
               engine_type_named(arena, "System.Text.Json.JsonDocument"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "EnsureSuccessStatusCode",
               engine_type_named(arena, "System.Net.Http.HttpResponseMessage"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "Content",
               engine_type_named(arena, "System.Net.Http.HttpContent"));
    ...
    REG_METHOD("Microsoft.Extensions.Logging.ILogger", "BeginScope",
               engine_type_named(arena, "System.IDisposable"));
    ...
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Ok",
               engine_type_named(arena, "Microsoft.AspNetCore.Mvc.OkObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "NotFound",
               engine_type_named(arena, "Microsoft.AspNetCore.Mvc.NotFoundObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "BadRequest",
               engine_type_named(arena, "Microsoft.AspNetCore.Mvc.BadRequestObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "StatusCode",
               engine_type_named(arena, "Microsoft.AspNetCore.Mvc.IActionResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Json",
               engine_type_named(arena, "Microsoft.AspNetCore.Mvc.JsonResult"));
    ...
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "Find", engine_type_type_param(arena, "T"));
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "FindAsync",
               engine_type_template(arena, "System.Threading.Tasks.ValueTask",
                                 (const EngineType *[]){engine_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Lazy", "Value", engine_type_type_param(arena, "T"));
    ...
    REG_GENERIC_TYPE_P1("System.Func", "Func", false,
                         "System.Delegate", single_t_params);
    REG_METHOD("System.Func", "Invoke", engine_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Tuple", "Item1", engine_type_type_param(arena, "T"));
    ...
    REG_STATIC("System.Diagnostics.Stopwatch", "StartNew",
               engine_type_named(arena, "System.Diagnostics.Stopwatch"));
    ...
    REG_METHOD("System.Diagnostics.Stopwatch", "Elapsed",
               engine_type_named(arena, "System.TimeSpan"));
