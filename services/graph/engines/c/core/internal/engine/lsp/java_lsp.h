#ifndef ENGINE_LSP_JAVA_LSP_H
#define ENGINE_LSP_JAVA_LSP_H
 ...
 *   2. Build a EngineTypeRegistry from this file's EngineDefinitions + Java
 ...
 *   5. Emit EngineResolvedCall entries with confidence ≥ 0.6 (the LSP floor
...
enum {
    ENGINE_JAVA_IMPORT_TYPE = 0,      /* import com.foo.Bar; — type import */
    ENGINE_JAVA_IMPORT_STATIC = 1,    /* import static com.foo.Bar.method; */
    ENGINE_JAVA_IMPORT_ON_DEMAND = 2, /* import com.foo.*; — package on-demand */
    ENGINE_JAVA_IMPORT_STATIC_OD = 3, /* import static com.foo.Bar.*; */
};
...
typedef struct {
    ...
    /* Import map. Each entry is one of ENGINE_JAVA_IMPORT_*.
 ...
 * engine_type_unknown(); never returns NULL. */
 ...
 * scoped_type_identifier, void_type, integral_type, ...) into a EngineType. */
 ...
 * type, or engine_type_unknown() on miss. */
