...
per-grammar license list is internal/engine/vendored/grammars/MANIFEST.md.
"""
...
version = sys.argv[1]
n_grammars = len(
    [d for d in glob.glob("internal/engine/vendored/grammars/*") if os.path.isdir(d)]
)
sbom = {
