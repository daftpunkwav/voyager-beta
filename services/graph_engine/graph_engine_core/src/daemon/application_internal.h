 ...
 */
#ifndef ENGINE_DAEMON_APPLICATION_INTERNAL_H
#define ENGINE_DAEMON_APPLICATION_INTERNAL_H

#include "daemon/application.h"
#include "mcp/mcp.h" /* engine_jsonrpc_request_t */
...
bool engine_daemon_application_session_retains_store_for_test(
    const engine_daemon_runtime_application_session_t *session);
...
#endif /* ENGINE_DAEMON_APPLICATION_INTERNAL_H */
