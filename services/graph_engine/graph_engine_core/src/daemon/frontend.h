 ...
 */
#ifndef ENGINE_DAEMON_FRONTEND_H
#define ENGINE_DAEMON_FRONTEND_H
...
typedef struct engine_daemon_maintenance_monitor engine_daemon_maintenance_monitor_t;
...
typedef bool (*engine_daemon_maintenance_cancel_fn)(void *context);
...
#endif /* ENGINE_DAEMON_FRONTEND_H */
