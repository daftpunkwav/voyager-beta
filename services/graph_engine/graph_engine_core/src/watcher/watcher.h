 ...
 */
#ifndef ENGINE_WATCHER_H
#define ENGINE_WATCHER_H
...
typedef struct engine_watcher engine_watcher_t;
...
typedef int (*engine_index_fn)(const char *project_name, const char *root_path, void *user_data);
...
typedef bool (*engine_watcher_project_mutation_begin_fn)(void *context, const char *project);
typedef void (*engine_watcher_project_mutation_end_fn)(void *context, const char *project);
typedef void (*engine_watcher_project_pruned_fn)(void *context, const char *project);
 ...
 * Precondition: engine_watcher_stop() + thread join must have completed. */
 ...
 * engine_watcher_stop() is called. Returns 0 on clean shutdown. */
