 ...
 */
#ifndef ENGINE_CONFIG_TOML_EDIT_H
#define ENGINE_CONFIG_TOML_EDIT_H
...
/* Remove one pre-marker graph-engine table only when it has the known
...
enum {
    ENGINE_TOML_OWNED_EDIT_ERROR = -1,
    ENGINE_TOML_OWNED_EDIT_OK = 0,
    ENGINE_TOML_OWNED_EDIT_FOREIGN = 1
};
...
typedef void (*engine_toml_precommit_test_hook_t)(const char *file_path, void *context);
...
#endif /* ENGINE_CONFIG_TOML_EDIT_H */
