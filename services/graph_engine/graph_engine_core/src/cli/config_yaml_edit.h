 ...
 */
#ifndef ENGINE_CONFIG_YAML_EDIT_H
#define ENGINE_CONFIG_YAML_EDIT_H
 ...
 * "<file_path>.engine-yaml.lock" regular file, created with mode 0600 and held by
 ...
 * engine_yaml_encode_double_quoted_scalar(). Full-line comments remain allowed.
 *
 ...
 * return ENGINE_YAML_IDENTITY_EDIT_FOREIGN. Errors return
 ...
 * engine_yaml_encode_double_quoted_scalar().
 *
 ...
 * ENGINE_YAML_IDENTITY_EDIT_FOREIGN. Removal deletes only the exact canonical
 ...
 * concurrency failures return ENGINE_YAML_IDENTITY_EDIT_ERROR byte-identically. */
enum {
    ENGINE_YAML_IDENTITY_EDIT_ERROR = -1,
    ENGINE_YAML_IDENTITY_EDIT_OK = 0,
    ENGINE_YAML_IDENTITY_EDIT_FOREIGN = 1
};
...
typedef void (*engine_yaml_precommit_test_hook_t)(const char *file_path, void *context);
...
typedef void (*engine_yaml_lock_postcreate_test_hook_t)(const char *lock_path, void *context);
...
#endif /* ENGINE_CONFIG_YAML_EDIT_H */
