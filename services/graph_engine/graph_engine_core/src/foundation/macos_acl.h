...
#ifndef ENGINE_FOUNDATION_MACOS_ACL_H
#define ENGINE_FOUNDATION_MACOS_ACL_H
...
bool engine_macos_extended_acl_fd_is_empty(int fd);
...
bool engine_macos_extended_acl_fd_is_deny_only(int fd);
...
bool engine_macos_extended_acl_fd_clear(int fd);
