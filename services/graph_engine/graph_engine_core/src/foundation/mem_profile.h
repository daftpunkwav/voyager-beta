 ...
 *
 * Off unless ENGINE_MEM_PROFILE=1. All tables are fixed-capacity and allocated
 ...
 */
#ifndef ENGINE_MEM_PROFILE_H
#define ENGINE_MEM_PROFILE_H

#include <stdbool.h>
#include <stddef.h>

/* Gate: ENGINE_MEM_PROFILE=1. Read once, cached. */
bool engine_mem_profile_enabled(void);

/* Minimum allocation size recorded, from ENGINE_MEM_PROFILE_MIN (bytes). */
