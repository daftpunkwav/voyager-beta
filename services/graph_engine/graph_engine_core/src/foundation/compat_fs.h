 ...
 */
#ifndef ENGINE_COMPAT_FS_H
#define ENGINE_COMPAT_FS_H
...
#define ENGINE_DIRENT_NAME_MAX 1024

typedef struct engine_dir engine_dir_t;

typedef struct {
    char name[ENGINE_DIRENT_NAME_MAX];
    bool is_dir;
 ...
 * valid until the next engine_readdir call on the same handle. */
